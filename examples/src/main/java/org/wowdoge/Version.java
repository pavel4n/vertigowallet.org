...
public class Version {
	public static final String appName = "Vertigo"; //"WowDoge";
	public static final String currentVersion = "0.3.9.1";
	public static final String preferencesName = "org.vertigowallet"; //org.wowdoge
	public static final String spvChainFileName = "vertcoins.vertspvchain"; //dogecoins.dogespvchain
	public static final String checkpointsFileName = "/org/wowdoge/vertigo.checkpoints"; //"/org/wowdoge/wowdoge.checkpoints"
	public static final String defaultWalletFileName = "vertcoins.vtcwallet"; //"dogecoins.dogewallet"
	public static final String walletFileExtension = "vtcwallet"; //"dogewallet";
	public static final String walletFileExtensionWithDot = ".vtcwallet"; //".dogewallet";
	public static final String walletFileDescription = "Vertigo VTC Wallet Files"; //"Wow DOGE Wallet Files";
	public static final String coinImagePath = "/org/wowdoge/vert.png"; //doge
	public static final String coinName = "VTC"; //"DOGE";
	public static final String coinNameWithSpace = "VTC "; //"DOGE ";
	public static final String coinNameLong = "Vertcoin";
	public static final String coinNameLongSmall = "vertcoin";
	...
	public static final String logFileName = "vertigo.log"; //wowdoge.log
	public static final String logFileNamePattern = "/vertigo.%d.log.gz"; //wowdoge
	public static final String appWebsite = "http://www.vertigowallet.org";
	public static final String appWebsiteWithoutHTTP = "www.vertigowallet.org";
	public static final String coinLibraryName = "VertcoinJ"; //"DogecoinJ";
	public static final int intCurrentVersion = toIntVersion(currentVersion);
	public static List<Version> versions = null;
	protected static final String updateURL = "http://www.vertigowallet.org/version.txt";
